...
export default function InterviewPrep() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 pb-20">
      <PageHeader title={t("nav.interview")} subtitle="Mock interviews with dynamic questions and STAR method evaluation." align="left" />
      ...
      {(step === "session" || step === "analyzing") && currentQuestion && (
        <div className="mt-8 animate-fade-in">
          <div className="flex justify-between items-center mb-4 px-2">
            ...
            <span className="font-body text-pencil/70 bg-white px-3 py-1 border-2 border-pencil wobbly-sm shadow-hard-sm">Role: {role}</span>
          </div>

          <QuestionCard question={currentQuestion.question} current={qas.length + 1} total={MAX_QUESTIONS} isFollowUp={isFollowUp} isSpeaking={isSpeaking} onToggleTTS={toggleTTS} />
            ...
            <div className="flex flex-col items-center py-6">
              {step === "analyzing" ? (
                ...
                <div className="text-center animate-fade-in">
                  ...
                  <p className="font-body text-pencil/70 mt-6 mb-6 max-w-md mx-auto">Try to structure your answer using the STAR method for the best score.</p>
